<script>
  ...
  let pokemon = {}
  $: getPokemon(id)
  export let pokemonSpriteGrande = pokemon.spriteGrande;
      ...
      <div class="status-pokemon">
        ...
        <div class="infos">
          <div class="grid-inline-tres">
            ...
            <div class="barra" style="width: 45%;">
              <span></span>
            </div>
          </div>
          <div class="grid-inline-tres">
            ...
            <div class="barra" style="width: 49%;">
              <span></span>
            </div>
          </div>
          <div class="grid-inline-tres">
          ...
          <div class="grid-inline-tres">
            ...
            <div class="barra" style="background-color: #ffdd57 !important; width: 65%;">
              <span></span>
            </div>
          </div>
          <div class="grid-inline-tres">
